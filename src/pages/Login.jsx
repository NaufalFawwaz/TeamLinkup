                ...
                <div className="w-full">
                    <div className="flex items-center justify-center min-h-screen">
                        <div className="flex-col mt-12">
                            ...
                            <div className="grid grid-cols-2 gap-[70px] mt-8">
                                <div className="border border-solid border-black w-[210px] py-3 px-6 rounded-lg flex flex-row items-center gap-4 text-2xl font-bold text-primary3">
                                    <img src={google} alt="google" className="w-auto h-[45px]" />
                                    Google
                                </div>
                                <div className="border border-solid border-black w-[210px] py-3 px-6 rounded-lg flex flex-row items-center gap-4 text-2xl font-bold text-primary3">
                                    <img src={line} alt="google" className="w-auto h-[45px]" />
                                    Line
                                </div>
                            </div>
